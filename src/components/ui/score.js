...
const Score = (props) => {
    ...
    const offset = (props.score * 630)/100;
...
<ul class="progress">
    ...
    <li data-name="" data-percent={`${Math.round(props.score)}%`}>
        <svg viewBox="-10 -10 220 220">
        <g fill="none" stroke-width="17" transform="translate(100,100)">
...
<linearGradient id="cl1" gradientUnits="objectBoundingBox" x1="0" y1="0" x2="1" y2="1">
    ...
    <stop offset="100%" stop-color="#7FAAFF"/>
</linearGradient>
...
<linearGradient id="cl3" gradientUnits="objectBoundingBox" x1="1" y1="0" x2="0" y2="1">
    ...
    <stop offset="100%" stop-color="#4C88FF"/>
</linearGradient>
...
<linearGradient id="cl5" gradientUnits="objectBoundingBox" x1="0" y1="1" x2="0" y2="0">
    ...
    <stop offset="100%" stop-color="#1966FF"/>
</linearGradient>
