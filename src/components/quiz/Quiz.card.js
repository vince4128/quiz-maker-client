...
const QuizCard = (props) => {    
    ...
    return (
        <li key={props.quiz._id}>
            <section className="m-card animated fadeIn">
                <div className="meta">
                    ...
                    <ul class="details">
                        <li className="author">
                            ...
                            crée par : {props.quiz.author.pseudo}
                        </li>
                        <li className="date">
                            <i>
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                ...
                <section className="description">
                    ...
                    <div class="read-more">
                        <div className="btns btns--quiz-card">
                            ...
                            <Link className="btn btn--primary" id="btn-preview" to={`/preview/${props.quiz._id}`}>
                                Prévisualiser
                                        </Link>
                            <Link className="btn btn--primary" to={`/share/${props.quiz._id}`}>
                                Partager
                                        </Link>
                            {props.quiz.author._id === props.userId ?
